...
Module dbSelects
    ...
    Public conString As String = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & System.AppDomain.CurrentDomain.BaseDirectory() & "//dbPaintShop.mdb;Jet OLEDB:Database Password=" & password & ";"
...
#Region "Connection"
    ...
    Public Function openConnectionSpecificDb(ByVal dbfileName As String) As Boolean
        Try
            Dim thisConString As String = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & dbfileName & ";Jet OLEDB:Database Password=" & password & ";"
            If DB.State = ConnectionState.Closed Or DB.State = ConnectionState.Broken Then
...
#Region "color"
    ...
    Public Function getColorByCode(ByVal colorCode As String) As Color
        If Not colors Is Nothing Then
            Dim i As Integer
            For i = 0 To colors.Length - 1
