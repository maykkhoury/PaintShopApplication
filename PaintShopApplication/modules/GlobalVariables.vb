...
#Region "Application start"
    ...
    Public Sub setVariables()
        ...
        SplashScreen1.lbInfosLoading.Text = "Setting languages"
        languages = getLanguages()

        SplashScreen1.lbInfosLoading.Text = "Setting units"
        units = getUnits()

        SplashScreen1.lbInfosLoading.Text = "Setting currencies"
        currencies = getCurrencies()

        SplashScreen1.lbInfosLoading.Text = "Setting labels"
        labels = getLabels()

        chosenGarage = getChosenGarage()

        SplashScreen1.lbInfosLoading.Text = "Setting colors"
        ...
        SplashScreen1.lbInfosLoading.Text = "Setting variants"
        setVariants()

        SplashScreen1.lbInfosLoading.Text = "Load completed"
