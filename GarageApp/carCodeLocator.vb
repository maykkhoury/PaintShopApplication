Public Class carCodeLocator
    ...
    Private Sub cmbCarCL_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbCarCL.SelectedIndexChanged
        ...
        If Not selectedCarObj Is Nothing Then
            Dim imgPath As String = My.Application.Info.DirectoryPath & "//images//" & selectedCarObj.carImgPath
            Try
    ...
    Private Sub butSearchCl_Click(sender As Object, e As EventArgs) Handles butSearchCl.Click
        ...
        'pctCodeLoc.Image = Image.FromFile(My.Application.Info.DirectoryPath & "//locatorsOutput.png")

    End Sub
    Private Function drawLocatorsImage(ByVal locPoints() As Point) As Image
        Dim greedDotImg As Image = Image.FromFile(My.Application.Info.DirectoryPath & "//darkgreen-dot.png")

        'Create image object from existing image
        Dim carsImg As Image = Image.FromFile(My.Application.Info.DirectoryPath & "//codelocator.gif")
        ...
        ' img.Save(My.Application.Info.DirectoryPath & "//locatorsOutput.png", ImageFormat.Png)
